...
def HALO_rotation(file_path, id, panel):
    ...
    HALO_rotation_df['Rotation'] = HALO_rotation_df['Rotation'].fillna(0) 
    HALO_rotation_df['Rotation'] = HALO_rotation_df['Rotation'].replace(r'^\s*$', 0, regex=True)  
